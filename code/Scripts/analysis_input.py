...
# SimAnalysis.plot_m_meq(file='CGT/paper_low_flu_thick', num_cgt_layers=45, save_file_name='CGT/thick_lowflu_m_meq.pdf')
...
SimAnalysis(files=files_thick).plot_spin_acc(S=1.5, Tc=65.)
