...
cgt = SimMaterials(name='CGT', tdeb=200, vat=1e-28, ce_gamma=737., cp_max=1.4e6,
                   kappap=1., kappae=0.0013, gep=15e16, spin=1.5, tc=65., muat=4., asf=0.13)
sio2 = SimMaterials(name='SiO2', tdeb=470, vat=1e-28, ce_gamma=0., cp_max=1.7e6, kappap=1.,
                    kappae=0., gep=5e17, spin=0, tc=0., muat=0., asf=0.)
...
sample = SimSample()
sample.add_layers(material=hbn, layers=8, dz=2e-9, pen_dep=1)
sample.add_layers(material=cgt, layers=8,  dz=2e-9, kappap_int='av', pen_dep=30e-9)
...
sim = SimDynamics(sample=sample, pulse=pulse, end_time=10e-12, ini_temp=6., solver='RK45', max_step=1e-13)
...
sim.save_data(solution, save_file='test_abs_sub_2')
