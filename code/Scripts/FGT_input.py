...
FGT = SimMaterials(name='Fe3GeTe2', cp_max=None, cp_method='input_data/FGT/FGT_c_p1.txt', tdeb=232.,  kappap=0.,
                   ...
                   asf=0.027, spin=2, tc=232., vat=127.76e-30, muat=1.6)
...
pulse = SimPulse(sample=sample, method='LB', pulse_width=15e-15, fluence=38e-3, delay=1e-12, therm_time=0)
...
sim.save_data(solution, save_file='FGT/M3TM_tp')
