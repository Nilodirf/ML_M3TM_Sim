...
plotter = SimPlot(file='FU_Tim_Terbium/full_sample/kappae_max')
...
plotter.map_plot(key='te', kind='surface', save_fig=True, filename='fullsam_te', show_title=False, color_scale='Reds')
plotter.map_plot(key='tp', kind='surface', save_fig=True, filename='fullsam_tp', show_title=False, color_scale='Blues')
