...
plotter = SimPlot(file='first_try_stephan_2')
...
plotter.map_plot(key='te', kind='surface', save_fig=False, filename='fullsam_te', show_title=False, color_scale='Reds', min_layer=0, max_layer=100)
plotter.map_plot(key='te', kind='surface', save_fig=False, filename='fullsam_tp', show_title=False, color_scale='Blues', min_layer=0, max_layer=100)
