...
# plotter.map_plot(key='te', kind='surface', save_fig=True, filename='tim_only_Tb_Abeles_te', show_title=False, color_scale='Reds')
# plotter.map_plot(key='tp', kind='surface', save_fig=True, filename='tim_only_Tb_Abeles_tp', show_title=False, color_scale='Blues')
...
# plotter.line_plot(key='te', min_layer=1, max_layer=6, average=True, save_fig=True, norm=False)
# plotter.line_plot(key='tp', min_layer=0, max_layer=55, average=False, save_fig=False, norm=False)
...
SimComparePlot(tim_fu_files).compare_samples(key='te', min_layers=[1, 1], max_layers=[6, 6], colors=['orange', 'green'],
                                             labels=['full sample Abeles', 'only Tb Abeles'], save_fig=True, filename='te_comp_Abeles')