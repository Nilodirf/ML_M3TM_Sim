...
fgt = SimMaterials(name='FGT', pen_dep=30e-9, tdeb=190, dz=1e-9, vat=1.7e-29, ce_gamma=1561., cp_max=2e6,
                   kappap=0.5, kappae=0.25, gep=6.5e17, spin=1.5, tc=220., muat=2., asf=0.04)
...
sample.add_layers(material=fgt, layers=8, kappap_int=10.)
sample.add_layers(material=sio2, layers=150, kappap_int=0.6)

# Create a laser pulse with the desired parameters. (Fluence in mJ/cm^2)
pulse = SimPulse(sample=sample, pulse_width=60e-15, fluence=3., delay=1e-12)
...
sim.save_data(solution, save_file='fgt/high_flu')
