...
Aluminium = SimMaterials(name='Al', tdeb=390, vat=1e-28, ce_gamma=135., cp_max=2.5e6, kappap=40.,
...
pulse = SimPulse(sample=sample, method='Abeles', pulse_width=20e-15, fluence=0.5, delay=0.5e-12, photon_energy_eV=1.55, theta=0, phi=1/4)
pulse.visualize(axis='z', save_fig=True, save_file='tim_full_sample_absorption_Abeles')
