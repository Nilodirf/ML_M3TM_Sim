...
plotter = SimPlot(file='FGT/thin_free_Sumit')
...
# plotter.te_tp_plot(max_time=5, average=False, save_fig=True,  filename='te_tp_thick', tp_layers=[8, 84], color_scales=['Greens_r', 'Blues_r'])  #8,84 for thick, 8,
