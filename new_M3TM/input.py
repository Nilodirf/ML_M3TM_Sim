...
hbn = SimMaterials(name='hBN', pen_dep=20e-9, tdeb=400, dz=7.7e-10, vat=1e-28, ce_gamma=300., cp_max=1.8e6, kappap=0.5,
                   kappae=0.1, gep=15e16, spin=0., tc=0., muat=0., asf=0.)
...
sio2 = SimMaterials(name='SiO2', pen_dep=1, tdeb=403, dz=5.4e-10, vat=1e-28, ce_gamma=0., cp_max=1.8e6, kappap=10.,
...
sample.add_layers(material=cgt, layers=70, kappap_int=0.5, kappae_int=0.1)
sample.add_layers(material=sio2, layers=553, kappap_int=10.)
...
sim.save_data(solution, save_file='150_nm_hbn_heating')
