...
cgt = SimMaterials(name='CGT', pen_dep=30e-9, tdeb=175, dz=20.5e-10, vat=1e-29, ce_gamma=737., cp_max=8.9e6,
                   kappap=0.1, kappae=0.0016, gep=15e16, spin=1.5, tc=65., muat=4., asf=0.25)
sio2 = SimMaterials(name='SiO2', pen_dep=1, tdeb=403, dz=5.4e-10, vat=1e-28, ce_gamma=0., cp_max=4e6, kappap=10.,
                    kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
hbn = SimMaterials(name='hBN', pen_dep=1, tdeb=400, dz=7.7e-10, vat=1e-28, ce_gamma=0., cp_max=4e6, kappap=1.,
                   kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
...
sample.add_layers(material=cgt, layers=70, kappap_int='min', kappae_int=0.)
sample.add_layers(material=sio2, layers=553, kappap_int='max')
...
sim = SimDynamics(sample=sample, pulse=pulse, end_time=1e-9, ini_temp=15., constant_cp=True)
...
sim.save_data(solution, save_file='150_nm_hbn_abs_high')
