...
hbn = SimMaterials(name='hBN', pen_dep=1, tdeb=400, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.8e6, kappap=.1,
                   kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
cgt = SimMaterials(name='CGT', pen_dep=20e-9, tdeb=175, dz=2e-9, vat=1e-28, ce_gamma=737., cp_max=8.9e6,
                   kappap=3., kappae=0.0016, gep=15e16, spin=1.5, tc=65., muat=4., asf=0.02)
sio2 = SimMaterials(name='SiO2', pen_dep=1, tdeb=403, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.9e6, kappap=4.,
                    kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
...
sample.add_layers(material=cgt, layers=70, kappap_int='av')
sample.add_layers(material=sio2, layers=150, kappap_int='max')
...
sim = SimDynamics(sample=sample, pulse=pulse, end_time=3e-9, ini_temp=15., constant_cp=False)
