...
hbn = SimMaterials(name='hBN', pen_dep=1, tdeb=400, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.6e5, kappap=5.,
                   kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
cgt = SimMaterials(name='CGT', pen_dep=20e-9, tdeb=175, dz=2.05e-9, vat=1e-28, ce_gamma=737., cp_max=5.2e6,
                   kappap=5., kappae=0.0016, gep=15e16, spin=1.5, tc=65., muat=4., asf=0.025)
sio2 = SimMaterials(name='SiO2', pen_dep=1, tdeb=403, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.7e5, kappap=3.,
                    kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
...
pulse = SimPulse(sample=sample, pulse_width=20e-15, fluence=1, delay=1e-12)
...
sim.save_data(solution, save_file='15_exact_10ps')
