...
hbn = SimMaterials(name='hBN', pen_dep=1, tdeb=400, dz=7.7e-10, vat=1e-28, ce_gamma=0., cp_max=1.8e6, kappap=0.5,
                   kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
cgt = SimMaterials(name='CGT', pen_dep=30e-9, tdeb=175, dz=20.5e-10, vat=1e-28, ce_gamma=737., cp_max=8.9e6,
...
sample.add_layers(material=cgt, layers=70, kappap_int=0.5)
