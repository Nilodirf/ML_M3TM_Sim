...
from mats import sim_materials
from sample import sim_sample
from pulse import sim_pulse

# Create the necessary materials. For documentation of the parameters see mats.sim_materials class:
cgt = sim_materials(name='CGT', pen_dep=10e-9, tdeb=175, dz=20.5e-10, vat=1e-27, ce_gamma=737., cp_max=8.9e4,
                    kappap=0.002, kappae=0., gep=15e16, spin=1.5, tc=65., muat=4., asf=0.01)
sio2 = sim_materials(name='SiO2', pen_dep=1, tdeb=403, dz=5.4e-10, vat=1e-28, ce_gamma=0., cp_max=4e6, kappap=14.,
                     kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
hbn = sim_materials(name='hBN', pen_dep=1, tdeb=400, dz=7.7e-10, vat=1e-28, ce_gamma=0., cp_max=4e6, kappap=36.,
                    kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
