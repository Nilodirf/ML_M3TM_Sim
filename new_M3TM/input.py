...
hbn = SimMaterials(name='hBN', pen_dep=1, tdeb=400, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.8e6, kappap=5.,
...
sio2 = SimMaterials(name='SiO2', pen_dep=1, tdeb=403, dz=2e-9, vat=1e-28, ce_gamma=0., cp_max=1.9e6, kappap=3.,
                    kappae=0., gep=0., spin=0., tc=0., muat=0., asf=0.)
...
pulse = SimPulse(sample=sample, pulse_width=20e-15, fluence=0.9, delay=1e-12)
...
sim.save_data(solution, save_file='150_exact')
