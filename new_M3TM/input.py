...
cgt = SimMaterials(name='CGT', pen_dep=10e-9, tdeb=175, dz=20.5e-10, vat=1e-29, ce_gamma=650., cp_max=8.9e6,
                   kappap=0.5, kappae=0.01, gep=15e16, spin=1.5, tc=65., muat=4., asf=0.3)
...
sample.add_layers(material=cgt, layers=90)
...
sim = SimDynamics(sample=sample, pulse=pulse, end_time=1e-9, ini_temp=5., constant_cp=True)
